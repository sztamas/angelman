...
setup(name='eresearchqut-newangelman',
      version="1.0.0",
      packages=packages,
      description='TRRF Angelman',
      long_description='Angelman is a patient registry based on TRRF (https://github.com/eresearchqut/trrf).',
